...
import './navbar.css'
import Logo from '../components/images/Untitled.png'
function Navbar() {
  return (
  ...
  <div className="dropdown-content dp">
  <p>Link 1</p>
  <p>Link 2</p>
  <p>Link 3</p>
  </div>
...
<div className='Logo'>
  <h1><span>S</span>hopMy<span>oo</span></h1>
...
<div className='mail-phone'>
  ...
  <div>
  <a href="tel:‪+91123-456-7890‬" className='phone'>
    Contact Us
</a> 
  </div>
</div>
...
<nav className="navbar">
  <div className="container-fluid">
    <form className="d-flex" role="search">
      ...
      <button className="btn bg-success btn-outline-light" type="submit">
